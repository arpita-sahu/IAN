...
n_epoch = 20
pre_processed = 1
embedding_file_name = "/content/drive/Shareddrives/Social Media False Info Propagation_V2/Arpita Sahu/IAN/data/glove.840B.300d.txt"
